package com.kutaykerem.artbooktesting.dependencyinjection
...
import com.kutaykerem.artbooktesting.repo.ArtRepository
import com.kutaykerem.artbooktesting.repo.ArtReposityInterface
import com.kutaykerem.artbooktesting.roomdb.ArtDao
import com.kutaykerem.artbooktesting.roomdb.ArtDatabase
import com.kutaykerem.artbooktesting.util.Util.BASE_URL
...
object AppModule {
    ...
    @Singleton
    @Provides
    fun injectNormalRepo(dao:ArtDao , api: RetrofitAPI) = ArtRepository(dao,api) as ArtReposityInterface
